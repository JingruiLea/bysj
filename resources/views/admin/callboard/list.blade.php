  ...
  <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <strong>{!!trans('callboard.breadcrumb.list')!!}</strong>
        </li>
      </ol>
    </div>
    <div class="col-lg-2">
      <div class="title-action">
        <a href="{{url('admin/callboard/createArticle')}}" class="btn btn-info">创建公告</a>
      </div>
    </div>
  </div>
...
@section('js')
  ...
  <script src="{{asset('admin/js/callboard/callboard-datatable.js')}}"></script>
